...
public class Evaluation {
    ...
    public Evaluation(File output_data_dir) throws IOException {
        ...
        var header = ("filename\tname\tkeyPhrase\tprediction\tnormalized\tnormalizingSieveName\tnormalizingSource\tgoldCui\tnormalizingName\tnormalizingSieveLevel\tgoldNames\tsnippet\n")
                .getBytes();
