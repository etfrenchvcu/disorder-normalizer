...
//             candidateCuiDataMap = ncbiPartialMatch(phrase, candidatePhrases, partialMatchedPhrases,
//                     map == 2 ? trainTerminology : standardTerminology, candidateCuiDataMap);
//         }
...
//     private Map<Integer, Map<String, Integer>> ncbiPartialMatch(String phrase, List<String> candidatePhrases,
//             List<String> partialMatchedPhrases, Terminology terminology,
//             Map<Integer, Map<String, Integer>> cuiCandidateDataMap) {
...
//     private String getCui(Map<String, Integer> cuiCandidateMatchedTokensCountMap,
//             Map<String, Integer> cuiCandidateLengthMap) {
//         String cui = "";
